          ...
          <div className="relative">
            {sent ? (
              <div className="text-center">
                <span className="mx-auto mb-4 inline-flex rounded-2xl bg-gradient-to-br from-orange-500 to-amber-500 p-3 shadow-lg shadow-orange-500/30">
                  <PaperAirplaneIcon className="h-7 w-7 text-white" />
                </span>
                <h2 className="text-xl font-bold">Revisa tu correo</h2>
                <p className="mt-2 text-sm text-white/60">
                  Si <b className="text-white/80">{email}</b> está registrado, te
                  enviamos un enlace para crear una nueva contraseña. Revisa tu
                  bandeja y la carpeta de spam. Vence en 30 minutos.
                </p>
                <a
                  href="/login"
                  className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl border border-white/15 px-4 py-3 text-sm font-semibold text-white/80 transition hover:bg-white/5"
                >
